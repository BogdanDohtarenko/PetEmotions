...
object DayInfoMapper {
    fun dbModelToEntity(dbModel: DayItemInfoDbModel): DayItemInfo {
        return DayItemInfo(date = dbModel.date, mood = dbModel?.mood, petId = dbModel.petId, attributeNames = dbModel.attributeNames)
    }
    fun entityToDbModel(entity:DayItemInfo): DayItemInfoDbModel {
        return DayItemInfoDbModel(date = entity.date, mood = entity?.mood, petId = entity.petId, attributeNames = entity.attributeNames)
    }
}